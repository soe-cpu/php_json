		...
		$("tbody").on("click",".edit",function(){
			...
			$.get("student.json",function(response){
				...
				if (response) {
					...
					var edit_name = response[id].name;
					var edit_email = response[id].email;
					var edit_gender = response[id].gender;
					var edit_address = response[id].address;
					var edit_profile = response[id].profile;
